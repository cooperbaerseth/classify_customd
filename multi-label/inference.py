...
parser.add_argument('--dataset_directory', type=str, required=False, default='data/inference_dataset',
...
for imgs in dataloader:
    ...
    for p in preds:
        ...
        for i, c in enumerate(p):
            if c == 1:
                batch_pred.append(class_order[i])
        predictions.append(batch_pred)

# save predictions in csv file -- file1,classA,classB /n file2,classC /n ...ect
pred_pairs = sorted(list(zip(inference_data.file_names, predictions)))
